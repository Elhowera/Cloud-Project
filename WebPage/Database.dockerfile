...
#docker cp "E:/College/Semester II Year II/Cloud Computing/Project/Cloud-Project/WebPage/config.inc.php" webpage-myxampp-1:/opt/lampp/phpmyadmin/config.inc.php
...
#To copy these files to my system
#docker cp webpage-myxampp-1:/opt/lampp/phpmyadmin/config.inc.php "E:/College/Semester II Year II/Cloud Computing/Project/Cloud-Project/WebPage/config.inc.php"
#docker cp webpage-myxampp-1:/opt/lampp/etc/extra/httpd-xampp.conf "E:/College/Semester II Year II/Cloud Computing/Project/Cloud-Project/WebPage/httpd-xampp.conf"
